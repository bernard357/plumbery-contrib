...
The objective of this use case is to deploy a web server powered by Nginx, at the [Managed Cloud Platform from Dimension Data](http://cloud.dimensiondata.com/eu/en/).
